...
async def run():
    ...
    await page.screenshot(path="screenshot_step3_verify.png")

    # 2. Check Step 3 -> Story transition
    print("Checking Step 3 to Story transition...")
    await page.wait_for_selector("text=Finalizar")
    ...
    if "/stories/" in page.url:
        ...
        print(f"FAILURE: Redirected to {page.url}")
    await page.screenshot(path="screenshot_story_verify.png")
